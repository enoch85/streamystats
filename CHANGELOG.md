...
## [2.19.0](https://github.com/enoch85/streamystats/compare/v2.18.0...v2.19.0) (2026-05-25)


### Features

* add "Title Count" aggregation option for people stats ([#399](https://github.com/enoch85/streamystats/issues/399)) ([dc85d25](https://github.com/enoch85/streamystats/commit/dc85d250c13f63e13c0221eaf416038bca16cc8c))
* add Asia/Karachi timezone option ([#414](https://github.com/enoch85/streamystats/issues/414)) ([6fe8791](https://github.com/enoch85/streamystats/commit/6fe879138f95f063625491d288be231d1db6dbea))
* add backfill endpoint for Jellyfin server IDs and update server data structure in job-server module ([61ae969](https://github.com/enoch85/streamystats/commit/61ae9690d7c1d7dd7e76aee8c667c5a09331fe2f))
* add Bangladesh Standard Time (Dhaka) to timezone options ([#389](https://github.com/enoch85/streamystats/issues/389)) ([467bcdc](https://github.com/enoch85/streamystats/commit/467bcdc0e6f8a9aee120aebd7f369d96dac0f4e8))
* add clickable links to library statistics cards ([1597522](https://github.com/enoch85/streamystats/commit/159752267eb80d395faedaeaf2f616db09a22d41))
* add external API support for watchlist CRUD operations ([7ee1a40](https://github.com/enoch85/streamystats/commit/7ee1a40784f92b381d00a2d7b5c4572aeebb00ff))
* add format and format:fix scripts for nextjs-app and update lint:fix command for safety ([f940d24](https://github.com/enoch85/streamystats/commit/f940d24083863df85b6f4563a8647107667119a3))
* add image proxy API for fetching Jellyfin images with server authentication ([79eb12d](https://github.com/enoch85/streamystats/commit/79eb12d7bfd2cdf1ff63c80ded4274d57046138c))
* add jellyfinId to servers and isPromoted to watchlists ([892906f](https://github.com/enoch85/streamystats/commit/892906fd410b1aae54010bcdf87fa4e46281f48e))
* add new API endpoints for recommendations and watchlists, including server identification and query parameters ([7cbfbce](https://github.com/enoch85/streamystats/commit/7cbfbce86e224f070d376799b1e1ca1bf6be2443))
* add OCI source label to Docker images for Renovatebot support ([73dd6ef](https://github.com/enoch85/streamystats/commit/73dd6ef2242ca32287eb75e29680448eff679cd5)), closes [#276](https://github.com/enoch85/streamystats/issues/276)
* add OpenRouter as AI provider and fix embedding URL bugs ([#451](https://github.com/enoch85/streamystats/issues/451)) ([33d618e](https://github.com/enoch85/streamystats/commit/33d618e500d8b5c84051fac0179e827f07da8784))
* add pause/resume logging with debouncing to prevent flickering ([ddcb786](https://github.com/enoch85/streamystats/commit/ddcb7864f89b7fcd68aba61a742468c25ea1db96))
* add per-server configurable job schedules ([744ab27](https://github.com/enoch85/streamystats/commit/744ab275f564f94527b2437529eb88d663fef0e6))
* add per-server timezone support ([63e0dc8](https://github.com/enoch85/streamystats/commit/63e0dc8e0b8ac956e66a4d7f1800a6e1fb3c1084))
* add promoted watchlists and external API improvements ([a61ec2c](https://github.com/enoch85/streamystats/commit/a61ec2cca8cb3de561d7f920793bb266db4024a0))
* Add session poller resilience and monitoring ([2a2dcdc](https://github.com/enoch85/streamystats/commit/2a2dcdcfec1b073f8215d52605b7eddf0b2f96ef))
* add SKIP_STARTUP_FULL_SYNC environment variable to skip full sync on server startup ([4db4772](https://github.com/enoch85/streamystats/commit/4db477228798507a87652bdc5b42ecc99cc9ca11))
* add typechecking scripts and CI workflow ([c49cb69](https://github.com/enoch85/streamystats/commit/c49cb696f8b4162489dac8cc752518d1a384cda4))
* add user sub-page handling and admin permission checks for security paths ([0d63d71](https://github.com/enoch85/streamystats/commit/0d63d719c9dcde0303960b36f05719d4b599d53c))
* add vaul dependency and implement Drawer component for improved UI in ChatDialog ([74c3c9c](https://github.com/enoch85/streamystats/commit/74c3c9c754aa5d5a659aa6114ba59e98e975a3ed))
* add wrapped design ([#345](https://github.com/enoch85/streamystats/issues/345)) ([c1b053d](https://github.com/enoch85/streamystats/commit/c1b053d635e78efee23ba77eb2d5f825e4342dba))
* ai tool watchtime per user and time interval ([c5a2b21](https://github.com/enoch85/streamystats/commit/c5a2b21e7e01f894595b909f9ece1a13363fb8cd))
* aio image and container ([b24da5e](https://github.com/enoch85/streamystats/commit/b24da5e0dfe0c5a2fc586315157e01e2cfa1a90f))
* almost done watching heatmap for user page (and me page) ([227998b](https://github.com/enoch85/streamystats/commit/227998bb9ba5db2052b0e242438e8f60e7c9dd19))
* **api:** add cors headers to recommendations endpoint ([f4ed35c](https://github.com/enoch85/streamystats/commit/f4ed35c6d4a669d70c0a1bd7ce22630ed280bd08))
* better history filters ([37972e9](https://github.com/enoch85/streamystats/commit/37972e9f06b1e889355ab9d0e8d8ee3aed75110e))
* bun test job in pr builds ([9013145](https://github.com/enoch85/streamystats/commit/9013145c4fbc32d14270b5d35c05680c43adc529))
* client stats ([e4db0de](https://github.com/enoch85/streamystats/commit/e4db0de0894f9cc224ec400ae903d0da2aea7f28))
* colors ([3e3ad21](https://github.com/enoch85/streamystats/commit/3e3ad2150c5f2d47faea49ecbbd893f0403a890b))
* dangerously merge similar items ([94e9532](https://github.com/enoch85/streamystats/commit/94e9532d02b0b13fd4b967bf645c38e2c9850cec))
* **docs:** aio instructions ([d5215ff](https://github.com/enoch85/streamystats/commit/d5215fffe430ac22ab2fe5c718736a5f59b0b9ae))
* dropdown actions in watchlist table ([7678d69](https://github.com/enoch85/streamystats/commit/7678d697af112bd5373d5e052250564422703147))
* endpoint for deleted items ([22f4aa5](https://github.com/enoch85/streamystats/commit/22f4aa589282aa8d56d9ffd35f31181515f67bea))
* enhance ActivityLogTable with user and activity type filters ([c60786a](https://github.com/enoch85/streamystats/commit/c60786a35678e2f31efa8e9bd9ab0bdb84a44882))
* enhance error handling and logging in embedding jobs ([b63894f](https://github.com/enoch85/streamystats/commit/b63894fe622dff94943c4e7c75c11907a03608ae))
* enhance ErrorBoundary with detailed error display and reporting options ([5682bfc](https://github.com/enoch85/streamystats/commit/5682bfcbecd50ba858fdaf0d62d25dcf0edc11cc))
* enhance text preparation for item embeddings with structured metadata and improved people data handling ([822840d](https://github.com/enoch85/streamystats/commit/822840de52812e7adfea17bc426e4d09048bbed4))
* export new backfill job and constants from server-jobs module ([d38c43d](https://github.com/enoch85/streamystats/commit/d38c43d050ea49c57101b97e451a83b49b1c16a6))
* global search ([31a4f21](https://github.com/enoch85/streamystats/commit/31a4f21063bdd9eae90c1d58f17d6e78f35fcbe4))
* global search ([d06c631](https://github.com/enoch85/streamystats/commit/d06c631f71a226e977e27a0082b4569d1a4140a3))
* global watchtime page date picker ([1c09ffc](https://github.com/enoch85/streamystats/commit/1c09ffc2ae09df8db7588e95c2e7aade02c76e0c))
* implement backfill job for Jellyfin IDs and enhance server data handling in job-server module ([36feea9](https://github.com/enoch85/streamystats/commit/36feea95f73acd1d18294fb4cc77aa05ea584f62))
* implement Jellyfin ID backfill trigger in SyncScheduler for servers without IDs ([f6a8638](https://github.com/enoch85/streamystats/commit/f6a863855fa6e8c50791639e7facc8d59df1100c))
* implement loading skeleton for login page and refactor component structure ([15904eb](https://github.com/enoch85/streamystats/commit/15904eb4a5fc4567627cfb461120c866388abe97))
* implement security dashboard layout and components ([c17c531](https://github.com/enoch85/streamystats/commit/c17c5312f7afe01202b5307fb7773e8afd25c54d))
* implement WatchlistsGrid component for displaying and managing user watchlists ([dccd851](https://github.com/enoch85/streamystats/commit/dccd85138feb8d11b0542c213543fe26158a9269))
* improve global search results ([#442](https://github.com/enoch85/streamystats/issues/442)) ([f2d62d2](https://github.com/enoch85/streamystats/commit/f2d62d2a54da5df52b197f62ab667e2f3f62b9f0))
* include history tool ([4f8a817](https://github.com/enoch85/streamystats/commit/4f8a8171bd71715ce3116753a09029b3cbb3c2a4))
* inf scroll for recommendations ([07b94d2](https://github.com/enoch85/streamystats/commit/07b94d28657351df571f97607f6aa8f40c119cce))
* inf scrolling for season recommendations ([c566994](https://github.com/enoch85/streamystats/commit/c566994412e444e5414927b3d92c97b4e7b6d024))
* infer sessions based on items marked as played ([4f67f28](https://github.com/enoch85/streamystats/commit/4f67f28cf76f30e61a102c1e7d0ed6ebdfa9fdde))
* infer sessions based on items marked as played ([fbb5f9e](https://github.com/enoch85/streamystats/commit/fbb5f9ef6ff6c70ddb363695a054ef116ab7dd8f))
* internal external url ([#335](https://github.com/enoch85/streamystats/issues/335)) ([bf414e8](https://github.com/enoch85/streamystats/commit/bf414e8423d95763399936b62ae1c7222de6cbb0))
* **job-server:** make cron schedules configurable via env vars ([3edef46](https://github.com/enoch85/streamystats/commit/3edef46f4f164bb36c4cbefc8ab8a48bee2d0750))
* library stats ([ee7accb](https://github.com/enoch85/streamystats/commit/ee7accb7f420b6b57490f39cb534f1b7244c0fa3))
* mark items as played and infer the watchtime ([a226f65](https://github.com/enoch85/streamystats/commit/a226f65f930fe35f4e447ef1eec57855a94593b1))
* match and merge series ([d88ad55](https://github.com/enoch85/streamystats/commit/d88ad55526b62dac46c9e3b004afe8b57c519c2a))
* merge all at once ([682908d](https://github.com/enoch85/streamystats/commit/682908db95de6b7a0f5711e058427e53d8ed6809))
* merge item stats ([afa66c6](https://github.com/enoch85/streamystats/commit/afa66c6102d4861627d8eb28e38c36a314b9a43a))
* more detection rules ([1d27511](https://github.com/enoch85/streamystats/commit/1d27511c926f6544867e15e6f3bfc32024ce381f))
* more watch stats ([f4653fc](https://github.com/enoch85/streamystats/commit/f4653fc24660e726083c27a5436f6c49f85e8046))
* people statistics ([de1c2a1](https://github.com/enoch85/streamystats/commit/de1c2a1e34c75d3cbf7b302b46ec6bbd4ce3c6b7))
* people stats ([ece9d38](https://github.com/enoch85/streamystats/commit/ece9d3858767a33f4eca66a0245aa6e65ed07ec9))
* recently added ([7910655](https://github.com/enoch85/streamystats/commit/7910655e6d59e01fd01e085954c05aa67e9249c3))
* recently added ([aff71d2](https://github.com/enoch85/streamystats/commit/aff71d26d2afd0e64c677490e765efb2004a90bc))
* recently added items on dashboard ([f826228](https://github.com/enoch85/streamystats/commit/f826228eca30f01539884323a09417ffe2da3e32))
* **recommendations:** add series recommendations support ([32c660a](https://github.com/enoch85/streamystats/commit/32c660a2e948694b05851af35132571f65bf124a))
* refresh button ([c4ca818](https://github.com/enoch85/streamystats/commit/c4ca818e76cfb91171b24e492ce1e49181aea0bb))
* register backfill job for Jellyfin IDs in job queue ([3d6a787](https://github.com/enoch85/streamystats/commit/3d6a7876953ca44ea5b6e6758df9540f766f8e55))
* route to user security page ([a443c7a](https://github.com/enoch85/streamystats/commit/a443c7a72ead741f5e4f198bf668136521dab10e))
* seasonal recomendations ([e839603](https://github.com/enoch85/streamystats/commit/e8396038a0d5acb78387e1f302436406033fb7df))
* see what user you share taste with ([c123290](https://github.com/enoch85/streamystats/commit/c1232905e91c4bb9fba8a8893b946134e5da3deb))
* separate audio from other ([44b2b39](https://github.com/enoch85/streamystats/commit/44b2b399a51eb6ea73c947795687c8813a14293e))
* show people sync in settings ([9327a5c](https://github.com/enoch85/streamystats/commit/9327a5ce454df94d44cd98abbc12e4952adfb2ba))
* show people sync progress in settings ([c762e04](https://github.com/enoch85/streamystats/commit/c762e041b80bcaf0280902277ded2166f781d570))
* show user list on pin ([961ad67](https://github.com/enoch85/streamystats/commit/961ad67753e7d24b32d3028409c4958777b4143d))
* switch Docker registry from Docker Hub to GHCR ([#476](https://github.com/enoch85/streamystats/issues/476)) ([4fa4ded](https://github.com/enoch85/streamystats/commit/4fa4dede1906d19888641d708c5866c0cccaa0db))
* **tests:** implement some tests for watchlists api ([5ce7344](https://github.com/enoch85/streamystats/commit/5ce7344e0867d4066efd938aa701eaa102e379bc))
* **ui:** improve user genre radar chart readability ([#412](https://github.com/enoch85/streamystats/issues/412)) ([ea62991](https://github.com/enoch85/streamystats/commit/ea62991b17fdf5e9f74c8324e67020373c6dd2cb))
* use cache  components ([a79867f](https://github.com/enoch85/streamystats/commit/a79867f8f98256b5ad13b55dcb305c8230c36050))
* use top items on user page ([448e175](https://github.com/enoch85/streamystats/commit/448e175e4941c79070fe04146c57100a07da8a22))
* user fingerprinting for security and determining shared accounts ([52adda9](https://github.com/enoch85/streamystats/commit/52adda93439bb01515c14a4d4a015b1fe58dd25e))
* watchlists ([7df353d](https://github.com/enoch85/streamystats/commit/7df353de7b97166f507177a4adbdae8c6d8e10fc))
* **watchlists:** add MediaBrowser auth support and sanitize searchVector from responses ([a0962df](https://github.com/enoch85/streamystats/commit/a0962df7ffff220dcfca4089c4e46cf2ea0809cf))


### Bug Fixes

* **#347:** useQueryParams should strip basePath from pathname ([ee1e337](https://github.com/enoch85/streamystats/commit/ee1e3377bf5ba08a1b867d1ea823e1f46c335ac2))
* actors breadcrumbs ([55cb29e](https://github.com/enoch85/streamystats/commit/55cb29eb3f79aa60974e2647731989e97fca19d3))
* add auth to unprotected API routes and remove dead image-proxy endpoint ([#427](https://github.com/enoch85/streamystats/issues/427)) ([de404ad](https://github.com/enoch85/streamystats/commit/de404ad220226b8cbb75dba9b79361e51dc08bc0))
* add authentication to people-sync-progress endpoint ([14650da](https://github.com/enoch85/streamystats/commit/14650daecffbba78b565463d71661509309d8bc9))
* add confirm modal ([48ee7ac](https://github.com/enoch85/streamystats/commit/48ee7ac5caf93ccd82df1fc61626d12287c26a52))
* add deleted items as schedule ([cd4ac64](https://github.com/enoch85/streamystats/commit/cd4ac648c14fd120cd7051456908e9fc9f83ee71))
* add DeviceId to Jellyfin auth headers for multi-device sessions ([#453](https://github.com/enoch85/streamystats/issues/453)) ([00d933b](https://github.com/enoch85/streamystats/commit/00d933b83917a7b9eebe6859d337c2003fc7622f))
* add force insert provider id if missing ([6c0fc43](https://github.com/enoch85/streamystats/commit/6c0fc43fb2638d5df4b47d6dacc148889026f7f7))
* add indexes for better performance ([4232cf7](https://github.com/enoch85/streamystats/commit/4232cf7ce9160e693474a2d37fe6d6deea268a52))
* add job-server health check condition in docker-compose ([76a97d1](https://github.com/enoch85/streamystats/commit/76a97d1a8043f0752a1d5c28d983fa19028ece12))
* add map key to solve Map reused bug ([116c70f](https://github.com/enoch85/streamystats/commit/116c70f990aacbd9bf7b0d98a5963f5615d82df4))
* add mapKey prop to solve Map reused bug ([ab67027](https://github.com/enoch85/streamystats/commit/ab670277f1dc3fc7b11f8a64c55ceca9a3e8adcc))
* add prop map key to solve map reused bug ([54c420c](https://github.com/enoch85/streamystats/commit/54c420cbbaa7ef2f131bd33b8aa7c74d7274e1b3))
* add security middleware and input validation to Next.js app ([#425](https://github.com/enoch85/streamystats/issues/425)) ([18f3b72](https://github.com/enoch85/streamystats/commit/18f3b72095fe1a837dbc10304703275a20475325))
* add voyage as distinct embedding provider to fix API parameter mismatch ([#420](https://github.com/enoch85/streamystats/issues/420)) ([#446](https://github.com/enoch85/streamystats/issues/446)) ([5b46469](https://github.com/enoch85/streamystats/commit/5b464691023689bd28b14de78e86309a1cf3f1be))
* address security audit findings for Docker and Next.js self-hosting ([7a2e336](https://github.com/enoch85/streamystats/commit/7a2e3369221dcfb965bcf9bc632432efa60f8c73))
* adjust margin for UserSimilarity component in user page ([f9369c8](https://github.com/enoch85/streamystats/commit/f9369c893e15bdfc6562675ebc94b312946b034c))
* aio container build ([17fcc73](https://github.com/enoch85/streamystats/commit/17fcc7318237f31700f6efb93ff58d6ef08e25ea))
* allow server creation without session auth ([#429](https://github.com/enoch85/streamystats/issues/429)) ([bb04813](https://github.com/enoch85/streamystats/commit/bb04813fd751c1f562e629cb17dde16233ff8361))
* better ai library search with rag ([6835417](https://github.com/enoch85/streamystats/commit/683541748b31cb7cfadfc23d735c1379c7a2bb5a))
* better copy for skipped job because of server budy ([b8af5a8](https://github.com/enoch85/streamystats/commit/b8af5a82f1d6caff01e225a5adf63270a80aa384))
* better design ([79e9387](https://github.com/enoch85/streamystats/commit/79e938729fa0b3153d69a18468e5392a8f524820))
* better error page ([3cad946](https://github.com/enoch85/streamystats/commit/3cad946cd04eaf936e24ec5c1fa7f9beabf50aed))
* better logs ([4357274](https://github.com/enoch85/streamystats/commit/435727465e8d676eb74d9581aa931e691b876cca))
* better match logic ([9041a72](https://github.com/enoch85/streamystats/commit/9041a72b9f01e568f662efc675e4f86c1671da34))
* better matching ([e0d4ce5](https://github.com/enoch85/streamystats/commit/e0d4ce5237ba4e520d134948d31a6e42246b7b54))
* better size ([d21efa1](https://github.com/enoch85/streamystats/commit/d21efa1cdd382ad64bce46d73ca3d51c5248480b))
* breadcrumbs for watchtime page ([c3847b4](https://github.com/enoch85/streamystats/commit/c3847b4c5c230f686de6c6ce89d80f1051dd21ab))
* build ([0eff520](https://github.com/enoch85/streamystats/commit/0eff5205defb83d003558e08a5db6b98cc7befce))
* build action ([cd6d375](https://github.com/enoch85/streamystats/commit/cd6d375c1a5608f5c1884a81a63194d62242f2ca))
* build error ([96aae63](https://github.com/enoch85/streamystats/commit/96aae63573b9c827c9d12683f56a634f34ca4850))
* build error ([4bf6334](https://github.com/enoch85/streamystats/commit/4bf63341a3c33e30f41463f366cea9f54ed0e69d))
* build error ([7ba7da4](https://github.com/enoch85/streamystats/commit/7ba7da4d3d51158d862ae604889dd0f9831cc871))
* build error ([caee7f3](https://github.com/enoch85/streamystats/commit/caee7f3d17445f8dac3e3a5e686026c562f173f4))
* build error ([9fee75a](https://github.com/enoch85/streamystats/commit/9fee75a9e1fb7a8656ca75d708d9e807cdc0d8a5))
* build issue ([1f46881](https://github.com/enoch85/streamystats/commit/1f468815a6eea1ba1819078db5a019730094bf06))
* build issue ([ff0ced6](https://github.com/enoch85/streamystats/commit/ff0ced6ffb7f8ceef054d4f4e107e79f2bfed0a6))
* build issue ([b5fd8ea](https://github.com/enoch85/streamystats/commit/b5fd8ea1470b325f77558bcbb64ba6cb9bfbb030))
* cache + remove arm from pr images ([cd49939](https://github.com/enoch85/streamystats/commit/cd49939ea240b534601b17af073eb017462b40fa))
* cache data ([c4cfee6](https://github.com/enoch85/streamystats/commit/c4cfee698c0a000a587bda5e080bd44f4fdcf23a))
* change to linegraph ([def8229](https://github.com/enoch85/streamystats/commit/def822964969c13b58d59a8e61b47d3ec7dc14a3))
* colors ([d7486f5](https://github.com/enoch85/streamystats/commit/d7486f523e2892395697c6d238e60a97dcb3fa0b))
* combine genres in spider graph fixes [#346](https://github.com/enoch85/streamystats/issues/346) ([be0f0dc](https://github.com/enoch85/streamystats/commit/be0f0dc6f4be66938f25d50c1146b9855663b0f4))
* connection issues ([12a0ba6](https://github.com/enoch85/streamystats/commit/12a0ba6a3edd04e78f507d2ee6d03219b4de53a2))
* copy geo files to expected location ([bbdf17d](https://github.com/enoch85/streamystats/commit/bbdf17d1b32b1d33cce73d7e99944de421de912d))
* copy real nextjs-app package.json in job-server and migration Dockerfiles ([c119c5f](https://github.com/enoch85/streamystats/commit/c119c5f901c64706eaf4f10360c633801324ea38))
* correct issue URL formatting in global error handling ([b241b67](https://github.com/enoch85/streamystats/commit/b241b678a3b540a8ebc4e54797cd89fa85c5acc5))
* correct migration 0041 ordering so internal_url column is applied ([bd6150c](https://github.com/enoch85/streamystats/commit/bd6150c1ad17c80414577e47254a3466c945bff2))
* correct watch time duration formatting in charts ([#390](https://github.com/enoch85/streamystats/issues/390)) ([79e28f1](https://github.com/enoch85/streamystats/commit/79e28f130911d501a581936239c8523ed6211dc5))
* correctly show total count to be merged ([4ce9e06](https://github.com/enoch85/streamystats/commit/4ce9e06ef03020623eabbd45a7527a12bf2cdf8a))
* date filter ([57e9df3](https://github.com/enoch85/streamystats/commit/57e9df338eb472fc40729768bfee210b2d2fcf10))
* deduplicate recommendations by item ID in user-specific recommendations ([8b5f573](https://github.com/enoch85/streamystats/commit/8b5f573b42931d269a658f607e193948a5cfa78c))
* delete old deletedAt item in favor of new item with data ([e2e1ee0](https://github.com/enoch85/streamystats/commit/e2e1ee016023945befa8f892b3466dc46a800662))
* deleted item show design ([839eadd](https://github.com/enoch85/streamystats/commit/839eadd48f096311e7f0cceacadd41d47ae96b52))
* design ([1359c02](https://github.com/enoch85/streamystats/commit/1359c02239ff858cd61a76c27a773a04c8aada88))
* design ([63c2d73](https://github.com/enoch85/streamystats/commit/63c2d733ed219149507bb7684b19c6674b6bb9a9))
* design ([d17a3a2](https://github.com/enoch85/streamystats/commit/d17a3a24c0c88033deac79cdd75a5259604d43c8))
* design and load improvements ([a2fdead](https://github.com/enoch85/streamystats/commit/a2fdeadc6291a90bb21c26a4ac40abe981e9faa1))
* design for recomendatinos ([dab2bf4](https://github.com/enoch85/streamystats/commit/dab2bf4849bb3a52e0ed571dbe0c510a79ef1030))
* **design:** rename chat ai and fix hover effect ([1937baa](https://github.com/enoch85/streamystats/commit/1937baa3731bb6a0aeb756665af3414676d616e5))
* **design:** toltip clipping card ([734f8a9](https://github.com/enoch85/streamystats/commit/734f8a96d7ff6d9caec8fc70bf3a467647e6607d))
* don't log checkpoints ([ca09b1c](https://github.com/enoch85/streamystats/commit/ca09b1cf7e95b0ec590cf9612450a8da7b72db49))
* don't require API key for openai api compatible models ([2a94328](https://github.com/enoch85/streamystats/commit/2a943284fd58bda9d0d567137bb33e6d5925d247))
* don't show recommended sections if no embeddings ([4e96669](https://github.com/enoch85/streamystats/commit/4e966691e4c1775583904afd3b12bced15d18163))
* duplicate fingerprint cleanup and improvement ([f975ab1](https://github.com/enoch85/streamystats/commit/f975ab180aae7979344c36bab340a90a4eec8d13))
* dynamically compute Lunar New Year zodiac animal ([#413](https://github.com/enoch85/streamystats/issues/413)) ([f1c5ab6](https://github.com/enoch85/streamystats/commit/f1c5ab618c0a4e6db697e9d113e2e11d5b64d80f))
* embeding dimensions edge case ([c1d4b88](https://github.com/enoch85/streamystats/commit/c1d4b88a5f5984f46e280c86ea1df3b588c41a32))
* enforce Jellyfin library access restrictions for non-admin users ([#459](https://github.com/enoch85/streamystats/issues/459)) ([a84ef24](https://github.com/enoch85/streamystats/commit/a84ef24a27deecbc3d6e995cb648c8b425262d26))
* ensure error handling only sends error messages when they are instances of Error ([5542eb6](https://github.com/enoch85/streamystats/commit/5542eb664f4c398f79370db612ec94a396b1cdd6))
* error ([e638b2c](https://github.com/enoch85/streamystats/commit/e638b2cf6c9b522509b0f10ec3e2e49e2332cfeb))
* failing test ([6978476](https://github.com/enoch85/streamystats/commit/6978476531de0b02260c01ac01fdb9a7c1277e64))
* fetch embedding config from DB for scheduled jobs ([#438](https://github.com/enoch85/streamystats/issues/438)) ([8e72944](https://github.com/enoch85/streamystats/commit/8e729442f41dcaa428c76a0657a7625f97af92b1))
* fetch MediaSources from Jellyfin and sync for existing items ([a194e16](https://github.com/enoch85/streamystats/commit/a194e169dedb78ad61d2b5379629df96d949c1d4))
* fetching outside of suspense ([b18ad26](https://github.com/enoch85/streamystats/commit/b18ad26eda58d6e322ef54e11344504a96caf7a8))
* filter deleted items in Almost Done to prevent duplicate episodes ([#441](https://github.com/enoch85/streamystats/issues/441)) ([f74efe3](https://github.com/enoch85/streamystats/commit/f74efe376a65a5fbf9ffdee6ee2a537e0ba1ac31))
* for aio container ([55ec986](https://github.com/enoch85/streamystats/commit/55ec986df09ce9acbd0fe2c4906f90103bac20f6))
* hard delete the old item after merge ([d8b8608](https://github.com/enoch85/streamystats/commit/d8b86088dd542cf3b73a6c6f8e24879f0a76152d))
* healthcheck in dockerfiles ([7d10ac7](https://github.com/enoch85/streamystats/commit/7d10ac7ae83b03854d97e96f8353af26ab65f77b))
* hide last played user from non-admin users on library page ([#415](https://github.com/enoch85/streamystats/issues/415)) ([375fcc3](https://github.com/enoch85/streamystats/commit/375fcc3222b10074f91ce86d3fbd29c408b91d9f))
* history table filters on user profile page ([169d0cb](https://github.com/enoch85/streamystats/commit/169d0cb0eb1f9af0cca1b301a2acc9cd311fb579))
* hydration issue ([9f1643e](https://github.com/enoch85/streamystats/commit/9f1643ef18e16912e3ee8ca427636ba1e7c0f7be))
* hydration warning ([a708b28](https://github.com/enoch85/streamystats/commit/a708b283dc03086e1a24ebcf309c6a05e049c158))
* hydration warnings ([563440e](https://github.com/enoch85/streamystats/commit/563440e5e91d9277d783f8244a2ae5b98b2bdad7))
* idempotent migration ([3465228](https://github.com/enoch85/streamystats/commit/346522826c50f96f097f56c0b8edc43bb11022bc))
* ignore mcp file ([ffd762f](https://github.com/enoch85/streamystats/commit/ffd762f9c8e7115f5307c3398bf15c96c5e6dcad))
* **images:** allow local IPs unconditionally to fix private Jellyfin servers ([f55c345](https://github.com/enoch85/streamystats/commit/f55c345b375ce3d15cc2eca561bdfdc23e518b37))
* implement conditional startup full sync based on SKIP_STARTUP_FULL_SYNC environment variable ([4e03ea7](https://github.com/enoch85/streamystats/commit/4e03ea7d36cd8c1cba3fab1956c6612671e32ef2))
* improve ai streaming chat response and tool listing ([7d4bba1](https://github.com/enoch85/streamystats/commit/7d4bba1f21effacda96e221345e4c2c8a0241f09))
* improve loading ([bfe544a](https://github.com/enoch85/streamystats/commit/bfe544ab52d8676b91692758bb99304d78afca60))
* improve mobile design ([f1409f8](https://github.com/enoch85/streamystats/commit/f1409f88553865adcd1dbb2e25105281ecf706f6))
* improve session poller reliability with retries and better error logging ([0912f63](https://github.com/enoch85/streamystats/commit/0912f638adfba5e20a403908707e9491fd172774))
* improve type safety for image field comparisons in hasImageFieldsChanged function ([255b313](https://github.com/enoch85/streamystats/commit/255b313a597018abd398d14601fa1d54314ca99a))
* improved api key saving ([51638a2](https://github.com/enoch85/streamystats/commit/51638a24c316db43dee3fb53811f472f2df6fc36))
* improved design recomendations ([81fd292](https://github.com/enoch85/streamystats/commit/81fd292f71f028b5ee15fb4a6f7970334a888bdb))
* include more fields ([866b6bc](https://github.com/enoch85/streamystats/commit/866b6bc2312c3ae1537f298ebb0a055abd37cf5e))
* include provider ids in sync process ([21ccb03](https://github.com/enoch85/streamystats/commit/21ccb032148d0b46be40adf885613ca65275aa35))
* instructions ([c31652a](https://github.com/enoch85/streamystats/commit/c31652a0a3de35a239610e4df73f428137069519))
* **jellyfin:** ensure isFolder defaults to false ([4fdeaea](https://github.com/enoch85/streamystats/commit/4fdeaea22497ab86a926ca0f5b6a60186b556a32))
* keep tab i query param ([9955ae6](https://github.com/enoch85/streamystats/commit/9955ae6e32d898e6c6f6d6083ab46603e61e34f2))
* less agressive activities sync ([0746292](https://github.com/enoch85/streamystats/commit/0746292edfae8fde52456f4555d5b2a2b65c081d))
* less data pulled from jellyfin ([533113f](https://github.com/enoch85/streamystats/commit/533113f08737b13f5e662a663b258536a20a0d71))
* lint ([af6856e](https://github.com/enoch85/streamystats/commit/af6856e6f68fa6d4bf80cc36596ad76627ba635d))
* lint ([5e656e9](https://github.com/enoch85/streamystats/commit/5e656e9ce292d8ef98a2af7b983245be13568200))
* lock bun version ([65fdeee](https://github.com/enoch85/streamystats/commit/65fdeee5f5befbc53375bd8b99882cefe5019461))
* logs ([61bc665](https://github.com/enoch85/streamystats/commit/61bc665f456b6b6b7c86c50a2bd31b8dfbecfab5))
* logs ([c399473](https://github.com/enoch85/streamystats/commit/c3994736d5672110647b76583dd5ff3c3bb23a7a))
* logs ([ae74975](https://github.com/enoch85/streamystats/commit/ae7497545fa9e219ad6b85801eb542e3886bfb1b))
* mark all as resolved ([7c2ab4f](https://github.com/enoch85/streamystats/commit/7c2ab4f01dad9a5f62d0ecb2410768080f92c044))
* mark items as synced manually instead of relying on people existing ([2892bb2](https://github.com/enoch85/streamystats/commit/2892bb2c76147d05b06f4c4f78ed8330cf50c74e))
* memory issue ([392b370](https://github.com/enoch85/streamystats/commit/392b3709dfadc6fd7b48950014061a8821c689e4))
* migrate Jellyfin API calls to MediaBrowser auth header ([#447](https://github.com/enoch85/streamystats/issues/447)) ([d041f47](https://github.com/enoch85/streamystats/commit/d041f474760c7f200295160267bd79d0537a2626))
* missed commit for pr 446 ([b44956b](https://github.com/enoch85/streamystats/commit/b44956bfc5ef88b6cc46e4396f1f7025650e29e9))
* missing geoip file ([2fca30a](https://github.com/enoch85/streamystats/commit/2fca30abd79ad78fe7521337a55fa614d62b8c11))
* move params await inside Suspense to avoid blocking route ([0ef9cef](https://github.com/enoch85/streamystats/commit/0ef9cefa7de54918ef5a8c8f98628a5a925c387d))
* movies only ([9f5f1bf](https://github.com/enoch85/streamystats/commit/9f5f1bf93c85d8482c7aa519ef3cd858f22d7a12))
* ollama connection issue ([e40c11b](https://github.com/enoch85/streamystats/commit/e40c11bcb32f6f825aa14b45026c4e70bd9006b4))
* only for admin ([e2b7d5b](https://github.com/enoch85/streamystats/commit/e2b7d5b04fd4120d15760fc7ed0c983a6a5e592e))
* only include items actually watched ([37b89d7](https://github.com/enoch85/streamystats/commit/37b89d7ea22a2aad1149df1aa1c3ab212b49d011))
* path ([a428f8b](https://github.com/enoch85/streamystats/commit/a428f8b34c6149d840565fe1dc79b7626cd63a3d))
* poster lqip loading ([aec5c25](https://github.com/enoch85/streamystats/commit/aec5c25867ba3fb543f8d0788b9c976bf5c3180a))
* prevent duplicate sessions and detect item/position changes in session poller ([fe26095](https://github.com/enoch85/streamystats/commit/fe260952d6a417375cb0ab9c345f69f8e184002d))
* prevent false deletions when Jellyfin server is down or return 0 items ([8462efb](https://github.com/enoch85/streamystats/commit/8462efbf7c143963df3a2962db47ff366885a28b))
* prevent iOS zoom on command input ([a463cbe](https://github.com/enoch85/streamystats/commit/a463cbed7440ea1b429d823829f89c6cf09a0245))
* prevent scheduler job loop by using unique schedule keys ([#458](https://github.com/enoch85/streamystats/issues/458)) ([0747ea9](https://github.com/enoch85/streamystats/commit/0747ea96c81bb8c2a12cce3229ea771b157d5356))
* reduce sync frequency and fix repeated item updates ([eb7b9bb](https://github.com/enoch85/streamystats/commit/eb7b9bb268e12fa11437e5a13b8440b2434f8650))
* remove non-async exports from api-auth server action module ([#520](https://github.com/enoch85/streamystats/issues/520)) ([5183492](https://github.com/enoch85/streamystats/commit/5183492d260a59838f4d91efb68af22bae8d0f2f))
* remove old cursor files ([bcf5644](https://github.com/enoch85/streamystats/commit/bcf5644b9dbecdf46748867fbf0fccf2600701e9))
* remove ssr wrapper ([b3e24ef](https://github.com/enoch85/streamystats/commit/b3e24ef7ec194f0b3a5c43f4a9259380ff043b9e))
* remove stale libraries during sync ([#417](https://github.com/enoch85/streamystats/issues/417)) ([57d15fa](https://github.com/enoch85/streamystats/commit/57d15fa8e66e9ed85181ca8c6f6489dcdf3873d5))
* rename database fields in job status endpoint ([cd543a2](https://github.com/enoch85/streamystats/commit/cd543a22f4b5fcc73545c2c79fb2124446e07d18))
* resolve full sync timeout and people sync crash ([#487](https://github.com/enoch85/streamystats/issues/487)) ([1d2c1c7](https://github.com/enoch85/streamystats/commit/1d2c1c74d0ab6e40b7afa2ee2585af5af1bf53b0))
* restore or migrate items on normal sync ([1afed43](https://github.com/enoch85/streamystats/commit/1afed436647b75926ae784d3758cd25e108f6c86))
* restore pause/resume session logging ([ba03d9e](https://github.com/enoch85/streamystats/commit/ba03d9e2ec63ea9f773bcb5fbce7c3572a27ea09))
* revert release action ([eb705d9](https://github.com/enoch85/streamystats/commit/eb705d9e26f8b4e4e9da529e65553242b2a1095a))
* scope people sync queries to server ID ([e7fabc4](https://github.com/enoch85/streamystats/commit/e7fabc42072bb1ab2b60a73fb4a8f8f08fb1dc6d))
* **search:** prioritize series/movies over episodes in search results ([#439](https://github.com/enoch85/streamystats/issues/439)) ([98e1571](https://github.com/enoch85/streamystats/commit/98e1571edff441540b79cd0bff8e0595e09767e0))
* series episode list ([64e1074](https://github.com/enoch85/streamystats/commit/64e1074ba29e9b942238d2752f1054d0fa15b5d5))
* set startTime/endTime on Jellystat import ([#350](https://github.com/enoch85/streamystats/issues/350)) ([#450](https://github.com/enoch85/streamystats/issues/450)) ([93753cd](https://github.com/enoch85/streamystats/commit/93753cdcf0a2285088b8683d599684feff8ef24a))
* settings menu in sidebar collapsed mode ([12a85a2](https://github.com/enoch85/streamystats/commit/12a85a2636fcbd3df64486e6084dae4640e8b14c))
* smaller image ([aac92dd](https://github.com/enoch85/streamystats/commit/aac92dd65f9903d0edea279539bb93eb0b3422a0))
* stale job status improvement ([51eae7e](https://github.com/enoch85/streamystats/commit/51eae7e27afb24599004fcadc1277644a447f3b1))
* status types and docs ([ac190d8](https://github.com/enoch85/streamystats/commit/ac190d8f9524301f99be2380a990dbe58012bf16))
* stop showing update notifications for latest Docker builds ([#416](https://github.com/enoch85/streamystats/issues/416)) ([dc75b07](https://github.com/enoch85/streamystats/commit/dc75b0735cd7ebea2597cef255fbd8e2f39f91b5))
* strip trailing slashes from AI base URLs ([95cf000](https://github.com/enoch85/streamystats/commit/95cf000488ef95677d89fd5da7026d86cee6574c)), closes [#324](https://github.com/enoch85/streamystats/issues/324)
* sync items on start ([56a14a9](https://github.com/enoch85/streamystats/commit/56a14a98f0837393eac6c8c21b3d763fbd3e8d4f))
* unwrap nested errors in formatError function for improved error handling ([116af7a](https://github.com/enoch85/streamystats/commit/116af7a52c84838b002e62b9225e49028aa215d0))
* update Dockerfile to use Debian base image and install dependencies with apt-get ([4b11388](https://github.com/enoch85/streamystats/commit/4b11388602cc52ced0e0f2fdae252fecc18a7947))
* update healthcheck to use 127.0.0.1 and remove redundant checks from docker-compose ([fd57920](https://github.com/enoch85/streamystats/commit/fd5792006cb7f5f033383d3871055b3ce4331ae1))
* update job status endpoint to include 'queue' in the URL path ([f1d4a04](https://github.com/enoch85/streamystats/commit/f1d4a04006d88cb3fdf78ae9102eac08767f537c))
* update supervisord configuration to include environment variables for database connections ([d8fcfd0](https://github.com/enoch85/streamystats/commit/d8fcfd00efefe0a7f42050576fe5984d7cc3f9dd))
* update trivy-action from 0.34.1 to 0.38.0 ([#461](https://github.com/enoch85/streamystats/issues/461)) ([41f5dad](https://github.com/enoch85/streamystats/commit/41f5dad51323ea259639acf6f41c1610417cc7bf))
* update VSCode settings to use explicit formatting and import organization actions ([24a95d5](https://github.com/enoch85/streamystats/commit/24a95d5e8b0259ef6b3b7172f12fc5ff09f23dd3))
* use chat for queries ([28c8556](https://github.com/enoch85/streamystats/commit/28c855605507562975af4913f0beb9849b1056ee))
* use deterministic session ID to prevent import duplicates ([#149](https://github.com/enoch85/streamystats/issues/149)) ([#448](https://github.com/enoch85/streamystats/issues/448)) ([dc5b8ab](https://github.com/enoch85/streamystats/commit/dc5b8abb0fd97d855454b327809c79f521c135bb))
* use FormattedDate in ActivityLogTable to fix hydration ([732fe37](https://github.com/enoch85/streamystats/commit/732fe376a78ca8328b571b53b22aec475da20a33))
* use next/navigation internal state instead ([8c3e5da](https://github.com/enoch85/streamystats/commit/8c3e5da126e0e7cbe8c478a47911bfb0ae400e9a))
* use SQL[] universally and remove any restore Server ([4bdf766](https://github.com/enoch85/streamystats/commit/4bdf766415b78be0c048286f7621e688b7304281))
* version badge zindex issue ([bbe6a22](https://github.com/enoch85/streamystats/commit/bbe6a227085435266780353892e2ad854de2f2fb))
* wrong db queries $1 ([200c1ed](https://github.com/enoch85/streamystats/commit/200c1edfd917cb4049bf318f9ce55d813ea9c74f))
* wrong url for mark watched ([b35043a](https://github.com/enoch85/streamystats/commit/b35043aee52af90e8e10bc24e1a167bc24e7d438))
* wrong video type in sections ([ea25a97](https://github.com/enoch85/streamystats/commit/ea25a970bd1ee129bde3f36f70174accc656d694))
